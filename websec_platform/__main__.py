...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(
        prog="websec",
        description="WebSec Platform — OWASP-based web application security testing toolkit",
    )
    ...
    if args.version:
        ...
        print(f"WebSec Platform v{__version__}")
        sys.exit(0)
    ...
    url = f"http://{cfg.HOST if cfg.HOST != '0.0.0.0' else '127.0.0.1'}:{cfg.PORT}"
